# Brief: Wing Tatters — the surface pass

**This is a RETROFIT, not a build.** `armorpieces_dragon:wing_tatters` is finished: its geometry is correct, its
...
- **Do not repaint the master.** `wing_tatters.png` is finished and it is the silhouette everything else
...
**1. Open it.**
    ...
    armorpieces_open { piece: "armorpieces_dragon:wing_tatters" }

No pack paths — this piece exists and `armorpieces_open` finds it by name. If it answers
`no piece armorpieces_dragon:wing_tatters`, **stop and tell me**: this Blockbench window's pack list has not been given
...
**3. Create the sheets.** This must come before painting — it is what creates them:
    ...
    armorpieces_set_part { fittings: ["armorpieces:inlay"], static: true }

**4. Paint the static layer.** Sheet `part_static`, real colour:

    armorpieces_paint { sheet: "part_static",
                       faces: { "front_strip_0.*": "#3b3046",
                                 "front_strip_1.*": "#3b3046",
                                 "second_strip_0.*": "#3b3046",
                                 "third_strip_0.*": "#3b3046",
                                 "third_strip_1.*": "#3b3046",
                                 "rear_strip_0.*": "#3b3046",
                                 "front_strip_0.up": "#5a4a70",
                                 "front_strip_1.up": "#5a4a70",
                                 "second_strip_0.up": "#5a4a70",
                                 "third_strip_0.up": "#5a4a70",
                                 "third_strip_1.up": "#5a4a70",
                                 "rear_strip_0.up": "#5a4a70" } }

| cubes | what it is | base | lit |
|---|---|---|---|
| `front_strip_0`, `front_strip_1`, `second_strip_0`, `third_strip_0`, `third_strip_1`, `rear_strip_0` | all six torn strips | `#3b3046` | `#5a4a70` on `up` |
...
**5. Paint the fitting mask.** Sheet `part_inlay`, flat **140**:

    armorpieces_paint { sheet: "part_inlay", faces: { "front_strip_0.*": 140, "front_strip_1.*": 140, "second_strip_0.*": 140, "third_strip_0.*": 140, "third_strip_1.*": 140, "rear_strip_0.*": 140 } }
