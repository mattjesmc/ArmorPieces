# Brief: Blaze Halo — the surface pass

**This is a RETROFIT, not a build.** `armorpieces_nether:blaze_halo` is finished: its geometry is correct, its
...
- **Do not repaint the master.** `blaze_halo.png` is finished and it is the silhouette everything else
...
**1. Open it.**
    ...
    armorpieces_open { piece: "armorpieces_nether:blaze_halo" }

No pack paths — this piece exists and `armorpieces_open` finds it by name. If it answers
`no piece armorpieces_nether:blaze_halo`, **stop and tell me**: this Blockbench window's pack list has not been given
...
|---|---|---|---|
| `rod_00_0`, `rod_45_0`, `rod_90_0`, `rod_135_0`, `rod_180_0`, `rod_225_0`, `rod_270_0`, `rod_315_0` | all eight rods | `#c98d10` | `#f2cd4e` on `up` |
...
**5. Paint the fitting mask.** Sheet `part_guard`, flat **140**:
    ...
    armorpieces_paint { sheet: "part_guard", faces: { "rod_00_0.*": 140, "rod_45_0.*": 140, "rod_90_0.*": 140, "rod_135_0.*": 140, "rod_180_0.*": 140, "rod_225_0.*": 140, "rod_270_0.*": 140, "rod_315_0.*": 140 } }
