# Brief: Dragon Talons — the surface pass

**This is a RETROFIT, not a build.** `armorpieces_dragon:dragon_talons` is finished: its geometry is correct, its
...
- **Do not repaint the master.** `dragon_talons.png` is finished and it is the silhouette everything else
...
**1. Open it.**
    ...
    armorpieces_open { piece: "armorpieces_dragon:dragon_talons" }

No pack paths — this piece exists and `armorpieces_open` finds it by name. If it answers
`no piece armorpieces_dragon:dragon_talons`, **stop and tell me**: this Blockbench window's pack list has not been given
...
**4. Paint the static layer.** Sheet `part_static`, real colour:
    ...
    armorpieces_paint { sheet: "part_static",
                       faces: { "talon_outer_0.*": "#141220",
                                 "talon_outer_1.*": "#141220",
                                 "talon_middle_0.*": "#141220",
                                 "talon_middle_1.*": "#141220",
                                 "talon_inner_0.*": "#141220",
                                 "talon_inner_1.*": "#141220",
                                 "talon_outer_0.up": "#2c2838",
                                 "talon_outer_1.up": "#2c2838",
                                 "talon_middle_0.up": "#2c2838",
                                 "talon_middle_1.up": "#2c2838",
                                 "talon_inner_0.up": "#2c2838",
                                 "talon_inner_1.up": "#2c2838" } }

| cubes | what it is | base | lit |
|---|---|---|---|
| `talon_outer_0`, `talon_outer_1`, `talon_middle_0`, `talon_middle_1`, `talon_inner_0`, `talon_inner_1` | the six talon cubes | `#141220` | `#2c2838` on `up` |
...
The heel mount `base_0` stays master greyscale under its new `guard` mask.
